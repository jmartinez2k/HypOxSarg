...
# Step 2: Add Year column if missing (e.g., if data was split by year)
summary_table_23_cleaned$Year <- 2023  # Explicitly add year
summary_table_24_cleaned$Year <- 2024

# Step 3: Combine the tables with corrected column names
...
# Step 4: Clean up column names (remove trailing spaces)
